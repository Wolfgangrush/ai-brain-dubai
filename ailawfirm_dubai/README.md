...
The Python package that powers **AI Brain — Dubai (DIFC)**.
...
This package follows the standard AI Brain — Dubai (DIFC) shape: a CLI entry point, a configuration loader, a set of specialist agents under `agents/`, an MCP server exposing the tools described in the top-level README, and a forked memory/retrieval layer.
