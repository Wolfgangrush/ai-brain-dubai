# Contributing to AI Brain — Dubai (DIFC)

Thanks for wanting to help. **AI Brain — Dubai (DIFC)** is open source (MIT). Contributions of all sizes are welcome — typo fixes, statute-corpus corrections, new drafting templates, agent improvements, and translations.
