...
**This document explains why AI Brain — Dubai collects no personal data from you, and what that means under UAE Federal Decree-Law No. 45/2021 (PDPL) and DIFC Data Protection Law No. 5/2020.**
...
AI Brain — Dubai is **local-first** software. Specifically:
...
**(2) The publisher operates no server.** No AI Brain Dubai API. No cloud service. No database.
