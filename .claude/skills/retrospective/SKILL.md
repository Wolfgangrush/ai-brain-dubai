---
name: retrospective
description: End-of-session save discipline for Dubai-DIFC AI Brain users. Runs 2-pass leak-check (Rule 6: no internal-shorthand, no internal-paths, no personal-build references). Saves session learning so the firm gets smarter with every use.
allowed-tools: Bash, Read, Glob
---

# /retrospective — End-of-Session Save Discipline (Dubai-DIFC)

Saves what the Dubai-DIFC AI Brain learned this session. Runs at session end. The firm accumulates knowledge across sessions without leaking personal context.
...
```
🧠 Dubai-DIFC AI Brain — session saved.
...
## Output Format
```markdown
## /retrospective — Dubai-DIFC AI Brain · Session Save
